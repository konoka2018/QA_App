...
public class QuestionDetailListAdapter extends BaseAdapter {
    ...
    /*getViewメソッドの中でgetItemViewTypeメソッドを呼び出してどちらのタイプか
      を判断してレイアウトファイルを指定します。
    ----------------------------------------------------------------------- */
    @Override
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (getItemViewType(position) == TYPE_QUESTION) {
            if (convertView == null) {
                convertView = mLayoutInflater.inflate(R.layout.list_question_detail,
                        parent, false);
            }
            ...
            if (convertView == null) {
                convertView = mLayoutInflater.inflate(R.layout.list_answer,
                        parent, false);
            }
